...
import type {
  TeePoolStorageV1,
  TeePoolStorageV1Interface,
} from "../../../../../contracts/mocks/teePool/interfaces/TeePoolStorageV1";
...
export class TeePoolStorageV1__factory {
  static readonly abi = _abi;
  static createInterface(): TeePoolStorageV1Interface {
    return new Interface(_abi) as TeePoolStorageV1Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TeePoolStorageV1 {
    return new Contract(address, _abi, runner) as unknown as TeePoolStorageV1;
  }
}
