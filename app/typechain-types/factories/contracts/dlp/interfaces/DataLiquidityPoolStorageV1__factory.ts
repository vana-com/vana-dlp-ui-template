...
import type {
  ...
  DataLiquidityPoolStorageV1Interface,
} from "../../../../contracts/dlp/interfaces/DataLiquidityPoolStorageV1";
...
export class DataLiquidityPoolStorageV1__factory {
  static readonly abi = _abi;
  static createInterface(): DataLiquidityPoolStorageV1Interface {
    return new Interface(_abi) as DataLiquidityPoolStorageV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as DataLiquidityPoolStorageV1;
  }
}
