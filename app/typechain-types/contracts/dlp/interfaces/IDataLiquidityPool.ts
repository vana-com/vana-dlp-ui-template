...
export interface IDataLiquidityPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IDataLiquidityPool extends BaseContract {
  connect(runner?: ContractRunner | null): IDataLiquidityPool;
  waitForDeployment(): Promise<this>;

  interface: IDataLiquidityPoolInterface;
